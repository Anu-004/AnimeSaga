        ...
        <div className="hero-content text-neutral-content text-center">
          <div className="max-w-md">
            ...
            <p className="mb-5 font-medium text-xl">
              ...
              Anime is known for its vibrant art, unique characters,distinctive
              style of cartoons and imaginative storytelling. Whether you’re
              into epic battles, heartfelt dramas, or fantastical worlds,
      ...
      >
        <div className="collapse collapse-arrow bg-base-200 mt-20">
          ...
          <div className="collapse-content">
            <p>
              AnimeSaga is a dedicated platform for anime lovers where users can
              explore a vast collection of anime shows and movies. The purpose
              of AnimeSaga is to provide anime enthusiasts with a seamless
              experience for discovering, searching, and learning about their
              favorite anime.
            </p>
          </div>
        </div>{" "}
        ...
        <div className="collapse collapse-arrow bg-base-200">
          ...
          <div className="collapse-content">
            <p>
              Allow users to search for specific anime titles, browse trending
              series, and discover hidden gems.
            </p>
          </div>
        </div>
        <br />
        <div className="collapse collapse-arrow bg-base-200">
          ...
          <div className="collapse-content">
            <p>
              Offer detailed information about a wide range of anime, including
              descriptions, images, and links to official pages like
              MyAnimeList.
            </p>
          </div>
        </div>
